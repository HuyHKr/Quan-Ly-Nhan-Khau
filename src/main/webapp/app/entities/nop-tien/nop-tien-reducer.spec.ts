...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './nop-tien.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOPTIEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOPTIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOPTIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOPTIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOPTIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOPTIEN actions', async () => {
      const expectedActions = [
        {
