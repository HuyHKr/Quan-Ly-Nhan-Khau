...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './khoan-thu.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KHOANTHU_LIST actions', async () => {
    ...
    it('dispatches FETCH_KHOANTHU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KHOANTHU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KHOANTHU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KHOANTHU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KHOANTHU actions', async () => {
      const expectedActions = [
        {
