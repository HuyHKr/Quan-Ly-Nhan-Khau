...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ho-khau.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOKHAU_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOKHAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOKHAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOKHAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOKHAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOKHAU actions', async () => {
      const expectedActions = [
        {
